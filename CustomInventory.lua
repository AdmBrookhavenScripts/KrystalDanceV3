...
G2L["2"]["Position"] = UDim2.new(0.5, 0, 0.925, -25);
G2L["2"]["BackgroundTransparency"] = .75;

-- StarterGui.Custom Inventory.Inventory.UIStroke
G2L["8a"] = Instance.new("UIStroke", G2L["2"]);
G2L["8a"]["Thickness"] = 1;
G2L["8a"]["Color"] = Color3.fromRGB(255, 255, 255);
G2L["8a"]["Transparency"] = 0;
...
-- StarterGui.Custom Inventory.Inventory.SearchBox.UIStroke
G2L["7a"] = Instance.new("UIStroke", G2L["6"]);
G2L["7a"]["Thickness"] = 1;
G2L["7a"]["Color"] = Color3.fromRGB(255, 255, 255);
G2L["7a"]["Transparency"] = 0;
...
SETTINGS.EQUIPPED_COLOR = Color3.fromRGB(120, 120, 120) -- ToolFrame background color when equipped
